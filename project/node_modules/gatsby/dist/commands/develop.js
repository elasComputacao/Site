...
function shutdownServices({
  ...
  const services = [developProcess.stop(signal), watcher === null || watcher === void 0 ? void 0 : watcher.close(), new Promise(resolve => statusServer.close(resolve)), new Promise(resolve => proxy.server.close(resolve))];
